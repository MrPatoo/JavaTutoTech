--TABLA ROLE--------------------------------------------------------------------------------------------------------------------------------------------------
CREATE TABLE tbROLE (
idRole NUMBER GENERATED AS IDENTITY START WITH 1 INCREMENT BY 1 PRIMARY KEY, -- Aqu� se incluye el auto-incremento
...
-- Eliminaci�n de datos en la tabla tbROLE
BEGIN
eliminar_role('admin');
eliminar_role('tutor');
...
--Comando para iniciar sesi�n en la aplicaci�n de Java o Android (Solo ejecutar si se va a testear)
...
BEGIN
    ...
    VALUES ('INSERT', 'tbTutoria', :NEW.idTutoria, :NEW.idUsuario, 'Inserci�n de una nueva tutor�a');
END;
...
BEGIN
    INSERT INTO tbAuditoria (tipoAccion, tablaAfectada, idRegistroAfectado, idUsuario, descripcionAccion)
    VALUES ('DELETE', 'tbTutoria', :OLD.idTutoria, :OLD.idUsuario, 'Eliminaci�n de una tutoria');
END;
...
BEGIN
    INSERT INTO tbAuditoria (tipoAccion, tablaAfectada, idRegistroAfectado, idUsuario, descripcionAccion)
    VALUES ('INSERT', 'tbLeccion', :NEW.idLeccion, :NEW.idUsuario, 'Inserci�n de una nueva leccion');
END;
...
BEGIN
    INSERT INTO tbAuditoria (tipoAccion, tablaAfectada, idRegistroAfectado, idUsuario, descripcionAccion)
    VALUES ('DELETE', 'tbLeccion', :NEW.idLeccion, :NEW.idUsuario, 'Eliminaci�n de una leccion');
END;
